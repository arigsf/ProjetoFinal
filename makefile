...
${BUILD_DIR}/Sistema.o: ${SRC_DIR}/Sistema.cpp ${INCLUDE_DIR}/Sistema.hpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR} -c ${SRC_DIR}/Sistema.cpp -o ${BUILD_DIR}/Sistema.o

${BUILD_DIR}/Funcoes.o: ${SRC_DIR}/Funcoes.cpp ${INCLUDE_DIR}/Funcoes.hpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR} -c ${SRC_DIR}/Funcoes.cpp -o ${BUILD_DIR}/Funcoes.o
...
${BUILD_DIR}/Cadastro_Clientes.o: ${SRC_DIR}/Cadastro_Clientes.cpp ${INCLUDE_DIR}/Cadastro_Clientes.hpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR} -c ${SRC_DIR}/Cadastro_Clientes.cpp -o ${BUILD_DIR}/Cadastro_Clientes.o

${BUILD_DIR}/Clientes.o: ${SRC_DIR}/Clientes.cpp ${INCLUDE_DIR}/Clientes.hpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR} -c ${SRC_DIR}/Clientes.cpp -o ${BUILD_DIR}/Clientes.o

${BUILD_DIR}/Locacao.o: ${SRC_DIR}/Locacao.cpp ${INCLUDE_DIR}/Locacao.hpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR} -c ${SRC_DIR}/Locacao.cpp -o ${BUILD_DIR}/Locacao.o

${BUILD_DIR}/Financeiro.o: ${SRC_DIR}/Financeiro.cpp ${INCLUDE_DIR}/Financeiro.hpp
	${CC} ${CFLAGS} -I ${INCLUDE_DIR} -c ${SRC_DIR}/Financeiro.cpp -o ${BUILD_DIR}/Financeiro.o
